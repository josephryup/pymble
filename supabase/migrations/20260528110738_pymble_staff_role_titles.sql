alter type public.ops_user_role add value if not exists 'managing_director';
alter type public.ops_user_role add value if not exists 'general_manager';
alter type public.ops_user_role add value if not exists 'human_resource';
alter type public.ops_user_role add value if not exists 'operations_manager';
alter type public.ops_user_role add value if not exists 'projects_manager';
alter type public.ops_user_role add value if not exists 'procurement_manager';
alter type public.ops_user_role add value if not exists 'quantity_surveyor';
alter type public.ops_user_role add value if not exists 'procurement';
alter type public.ops_user_role add value if not exists 'procurement_assistant';
alter type public.ops_user_role add value if not exists 'finance_manager';
alter type public.ops_user_role add value if not exists 'accountant';
alter type public.ops_user_role add value if not exists 'engineer';
alter type public.ops_user_role add value if not exists 'hse_officer';
alter type public.ops_user_role add value if not exists 'hse_assistant_officer';
alter type public.ops_user_role add value if not exists 'admin_receptionist';
