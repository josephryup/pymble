 ...
 * Services Page
 * ================================================
 * Dedicated page for Pymble Construction's core services.
 * Each service is presented as a full-section card with
 * icon, description, and key capabilities.
 *
 * Services sourced from client questionnaire:
 * - Building Construction
 * - Renovations
 * - Civil Works
 * - Infrastructure Development
 *
 * Design: Alternating dark/light sections for visual rhythm.
 * Brand: Midnight Navy base, accent orange highlights.
 * ================================================
 */
