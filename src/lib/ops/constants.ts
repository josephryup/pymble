...
export const OPS_MODULES: OpsModule[] = [
  ...
  {
    description: "Periodic department reports submitted by department heads and routed to the Managing Director and General Manager for review. Reports stay within the originating department until leadership receives them.",
    group: "executive",
